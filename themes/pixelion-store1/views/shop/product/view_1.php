        ...
        <div class="col-md-7">
            ...
            <div class="price">
                <span id="productPrice">
                    <?= ShopProduct::formatPrice($model->getFrontPrice()); ?>
                </span>
            ...
            if (Yii::app()->hasModule('discounts')) {
                if ($model->appliedDiscount) {
                    ?>
                    <div class="product-price clearfix product-price-discount"><span><?= ShopProduct::formatPrice(Yii::app()->currency->convert($model->originalPrice)) ?></span><sup><?= Yii::app()->currency->active->symbol ?></sup></div>
                    <?php
                }
            }
            ?>
