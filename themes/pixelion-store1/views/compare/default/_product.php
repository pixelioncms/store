...
<li>
            ...
            <div class="product-availability">
                ...
                <div class="product-price">
                    ...
                    if ($data->appliedDiscount) {
                        ?>
                        <span class="price price-xs price-discount"><?= ShopProduct::formatPrice($data->priceOriginal) ?> <sub><?= Yii::app()->currency->active->symbol; ?></sub></span>
                        <?php
                    }
                    ?>
    ...
    <table class="table table-striped compare-table">
        ...
        if(isset($this->model->attributes[$catId][$data->id])){

        foreach ($this->model->attributes[$catId][$data->id]['attrs'] as $attribute) {
            if ($isType) {
                $unq = array();
