...
/**
 * This is the model class for table "ShopProductVariant".
 *
 * The followings are the available columns in table 'ShopProductVariant':
 * @property integer $id
 ...
 * @property string $sku
 */
class ShopProductVariant extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ShopProductVariant the static model class
     */
    ...
    public function relations() {
        return array(
            ...
            'option' => array(self::BELONGS_TO, 'ShopAttributeOption', 'option_id'),
        );
    }
