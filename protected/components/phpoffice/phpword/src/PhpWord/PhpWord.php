...
Yii::import('app.phpoffice.phpword.src.PhpWord.Exception.Exception');
...
class PhpWord
{
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            ...
            Yii::import("app.phpoffice.phpword.src.PhpWord.Collection.{$collection}");
            $class = $collection;
        ...
        foreach ($metadata as $meta) {
            Yii::import("app.phpoffice.phpword.src.PhpWord.Metadata.{$meta}");
    ...
    public function __call($function, $args)
    {
        ...
        foreach ($collections as $collection) {
            ...
            //Yii::import("app.phpoffice.phpword.src.PhpWord.Style.{$collection}");
        ...
        foreach ($styles as $style) {
           // Yii::import("app.phpoffice.phpword.src.PhpWord.Style.{$style}");
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('Style', $function), $args);
        }
