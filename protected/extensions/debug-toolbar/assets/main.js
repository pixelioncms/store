(function($){
    YiiDebugToolbar = {
        ...
        init : function() {
            ...
            $('table#debug-table tr').mouseenter(function(){
            ...
            $('div.debug-options i').bind('click', $.proxy(function(e) {
            	var $target = $('#ydtb-toolbar');
            	$target.toggleClass('ydtb-slim');
            	this.ic('.ydtb-slim', $target.hasClass('ydtb-slim'));
            }, this));

            $('#ydtb-toolbar i.icon-delete').bind('click', $.proxy(function(e){
            	var $el = $(e.currentTarget);
            	localStorage.setItem('ydtb-panel-lock', $el.data('ydtb-collapse'));
            	$('div[data-ydtb-panel]').removeClass('ydtb-panel-lock');
            	$('div[data-ydtb-panel="'+$el.data('ydtb-panel-lock')+'"]').addClass('ydtb-collapse');
            }, this));
