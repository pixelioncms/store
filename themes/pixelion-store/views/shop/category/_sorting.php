<?php
echo Html::beginForm(array('/shop/category/view', 'seo_alias' => $this->dataModel->full_path), 'POST', array('id' => 'sorting-form'));
?>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-md-5 col-lg-5">
                  ...
                  //  $sorter[Yii::app()->request->addUrlParam('/shop/category/view', array('sort' => 'date_create.desc'))] = Yii::t('ShopModule.default', 'SORT_BY', 3);
                    ...
                    $sorter['date_create.desc'] = Yii::t('ShopModule.default', 'SORT_BY', 3);


                    echo Html::dropDownList('sort', $active, $sorter, array(
                ...
                <div class="col-sm-3 col-md-4 col-lg-4">
                    ...
                    $limits = array('' => $this->allowedPageLimit[0]);
