 ...
 */
class FormInputElement1 extends CFormInputElement {
        ...
        if (isset(self::$coreTypes[$this->type])) {
            ...
            if ($method == 'activeRead') {
                ...
                $("#addd").click(function(){
                 ...
                 $(".field_phone .col-sm-8").append(row);
                });
    ...
    private function overlayInput($input, $class=false) {
        ...
        if (!empty($this->afterContent) || !empty($this->beforeContent)) {
            ...
            return Html::tag('div', array('class' => 'input-group '.$mclass), $before . $input . $after, true);
        } else {
            return $input;
        }
    }
