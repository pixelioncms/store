<tr>
    ...
    <td class="col-md-5">
        ...
        <div class="price"><?= Yii::app()->currency->number_format($data->getFrontPrice()); ?> <?= Yii::app()->currency->active->symbol; ?>

            <?php
            if (Yii::app()->hasModule('discounts')) {
                if ($data->appliedDiscount) {
                    ?>
                    <span><?= Yii::app()->currency->number_format(Yii::app()->currency->convert($data->originalPrice)) ?> <?= Yii::app()->currency->active->symbol ?></span>
