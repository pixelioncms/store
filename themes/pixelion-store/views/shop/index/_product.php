<?php
if ($data->mainImage)
    $imgSource = $data->mainImage->getUrl('142x153');
else
    $imgSource = CMS::placeholderUrl(array('size'=>'190x150'));
//echo CHtml::link(CHtml::image($imgSource, $data->mainImageTitle), array('Product/view', 'url'=>$data->url), array('class'=>'thumbnail'));
?>
<div class="product floatleft width25">
    <div class="spacer">
        <div class="cat-image">
            <a class="modal" href=""><img src="<?php echo $imgSource ?>" alt="img-leo-tools-14" class="featuredProductImage" border="0" /></a>                    <h3>
                <a href="#" title="Fermentum">Fermentum1111111111111</a>				</h3>
            <div class="cat-view">	
