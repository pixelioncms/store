...
Yii::import('app.forsage.ForsageProductImage');
 ...
 */
class ForsageProductsImport extends CComponent
{
     ...
     */
    public $tempDirectory = 'application.runtime.forsage';
    public $countNoAdd = 0;
    public $countAdd = 0;
    /**
     * @var string
...
$starttime = microtime(true);
    ...
    private static function log($msg, $level = 'info', $category = 'console')
    {
    ...
    private function conn_curl($url)
    {
        ...
        $response = CJSON::decode(curl_exec($ch), false);
        curl_close($ch);
        return $response;
    }
