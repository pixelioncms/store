...
Yii::import('app.phpword.PHPWord.Section.Section_Settings');
Yii::import('app.phpword.PHPWord.Section.Section_Text');
Yii::import('app.phpword.PHPWord.Section.Section_TextBreak');
/**
 * PHPWord_Section
 *
 * @category   PHPWord
...
class Section {
	...
	public function __construct($sectionCount, $settings = null) {
		...
		$this->_settings = new Section_Settings();
	...
	public function addText($text, $styleFont = null, $styleParagraph = null) {
		//$givenText = utf8_encode($text);
                $givenText = $text;
		$text = new Section_Text($givenText, $styleFont, $styleParagraph);
	...
	public function addLink($linkSrc, $linkName = null, $styleFont = null, $styleParagraph = null) {
		...
		$link = new Section_Link($linkSrc, $linkName, $styleFont, $styleParagraph);
	...
	public function addTextBreak($count = 1) {
		for($i=1; $i<=$count; $i++) {
			$this->_elementCollection[] = new Section_TextBreak();
		}
	}
	...
	public function addPageBreak() {
		$this->_elementCollection[] = new Section_PageBreak();
	}
	...
	public function addTable($style = null) {
		$table = new Section_Table('section', $this->_sectionCount, $style);
	...
	public function addListItem($text, $depth = 0, $styleFont = null, $styleList = null, $styleParagraph = null) {
		...
		$listItem = new Section_ListItem($text, $depth, $styleFont, $styleList, $styleParagraph);
	...
	public function addObject($src, $style = null) {
		$object = new Section_Object($src, $style);
	...
	public function addImage($src, $style = null) {
		$image = new Section_Image($src, $style);
	...
	public function addMemoryImage($link, $style = null) {
		$memoryImage = new Section_MemoryImage($link, $style);
	...
	public function addTitle($text, $depth = 1) {
		...
		$title = new Section_Title($text, $depth, $style);
	...
	public function createTextRun($styleParagraph = null) {
		$textRun = new Section_TextRun($styleParagraph);
	...
	public function createHeader() {
		$header = new Section_Header($this->_sectionCount);
		$this->_header = $header;
		return $header;
	}
	...
	public function createFooter() {
		$footer = new Section_Footer($this->_sectionCount);
		$this->_footer = $footer;
		return $footer;
	}
