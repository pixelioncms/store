...
class MbMenu extends CMenu {
    ...
    public function registerClientScripts() {
        ...
        $cs->registerScript('mbmenu_' . $this->getId(), $this->createJsCode(), CClientScript::POS_READY);
    ...
    protected function renderMenuRecursive($items) {
        ...
        foreach ($items as $item) {
            ...
            if (isset($item['url']))
                echo CHtml::link('<span class="icon-medium ' . $item['icon'] . '"></span> ' . $item['label'] . ' '.$totalCount, $item['url'], isset($item['linkOptions']) ? $item['linkOptions'] : array('data-target'=>'#'));
            else
                echo CHtml::link('<span class="icon-medium ' . $item['icon'] . '"></span> ' . $item['label'] . ' '.$totalCount, "#", isset($item['linkOptions']) ? $item['linkOptions'] : array('data-target'=>'#'));
