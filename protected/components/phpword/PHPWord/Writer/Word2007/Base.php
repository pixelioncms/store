...
Yii::import('app.phpword.PHPWord.Writer.Word2007.WriterPart');
Yii::import('app.phpword.PHPWord.Shared.Shared_XMLWriter');
Yii::import('app.phpword.PHPWord.Shared.String');



class Base extends WriterPart {
	
	protected function _writeText(Shared_XMLWriter $objWriter = null, Section_Text $text, $withoutP = false) {
	...
	protected function _writeTextRun(Shared_XMLWriter $objWriter = null, Section_TextRun $textrun) {
		...
		if(count($elements) > 0) {
			foreach($elements as $element) {
				if($element instanceof Section_Text) {
					$this->_writeText($objWriter, $element, true);
				} elseif($element instanceof Section_Link) {
	...
	protected function _writeParagraphStyle(Shared_XMLWriter $objWriter = null, Paragraph $style, $withoutPPR = false) {
	...
	protected function _writeLink(Shared_XMLWriter $objWriter = null, Section_Link $link, $withoutP = false) {
	...
	protected function _writePreserveText(Shared_XMLWriter $objWriter = null, PHPWord_Section_Footer_PreserveText $textrun) {
	...
	protected function _writeTextStyle(Shared_XMLWriter $objWriter = null, Font $style) {
		$font = $style->getName();
		$bold = $style->getBold();
	...
	protected function _writeTextBreak(Shared_XMLWriter $objWriter = null) {
		$objWriter->writeElement('w:p', null);
	}
	
	protected function _writeTable(Shared_XMLWriter $objWriter = null, Section_Table $table) {
		$_rows = $table->getRows();
		$_cRows = count($_rows);
	...
	protected function _writeTableStyle(Shared_XMLWriter $objWriter = null, Table $style = null) {
	...
	protected function _writeCellStyle(Shared_XMLWriter $objWriter = null, Cell $style = null) {
	...
	protected function _writeImage(Shared_XMLWriter $objWriter = null, $image) {
	...
	protected function _writeWatermark(Shared_XMLWriter $objWriter = null, $image) {
		$rId = $image->getRelationId();
	...
	protected function _writeTitle(Shared_XMLWriter $objWriter = null, Section_Title $title) {
