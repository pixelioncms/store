...
*/
Yii::import("app.phpoffice.common.src.Common.Common_XMLWriter");


// use as
Yii::import("app.phpoffice.phpword.src.PhpWord.Element.AbstractContainer");
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Element.Word2007AbstractElement");
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Element.TextBreak");


//use AbstractContainer as ContainerElement;
use Word2007AbstractElement as Element;
use TextBreak as TextBreakElement;
 ...
 * @since 0.11.0
 */
class Container extends Word2007AbstractElement
{
    /**
   ...
   // protected $namespace = 'PhpOffice\\PhpWord\\Writer\\Word2007\\Element';
    ...
    public function write()
    {
        ...
        if (!$container instanceof Word2007AbstractElement) {//ContainerElement
            return;
        }
     ...
     * @return string
     */
    private function writeElement(Common_XMLWriter $xmlWriter, Element $element, $withoutP)
    {
