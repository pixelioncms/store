<div class="col-sm-12 col-md-3 sidebar">
    ...
    <?php $this->widget('mod.shop.widgets.categories.CategoriesWidget', array('skin' => 'current_theme.views.layouts.inc._widget_categories')) ?>
    <div id="testf">
        <?php
...
<div class="col-sm-12 col-md-9">
    ...
    <?php $this->renderPartial('_sorting', array('itemView' => $itemView)); ?>
