...
?>
    ...
    <header id="header-static">
        <div class="left-skew d-none d-lg-block"></div>
        <nav class="navbar navbar-expand-lg" id="navbar">
            <div class="container-fluid" style="position: relative">
                ...
                <div class="header-contact  mr-auto">
                    <span>Viber, Telegram, WhatsApp</span>

                    <div><a href="tel:+380634892695">+38 (063) 489-26-95</a></div>
                </div>
                ...
                <a class="btn btn-default btn-orderproject" href="#" id="yt1">Оставить заявку</a>            <div class="navbar-collapse menu offcanvas-collapse">

                    <!--<div class="nav-close" data-toggle="offcanvas"></div>-->
                    <div class="container-menu">
                        ...
                        <div>
                            <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="/projects">Работы</a></li>
                                <li class="nav-item"><a class="nav-link" href="/page/services">Услуги & цены</a></li>
                                <li class="nav-item"><a class="nav-link" href="/#section-contacts">Контакты</a></li>
                            </ul>

                            <ul id="langs">
                                <li class="active">
                                    <a class="text-uppercase" href="/projects">ru</a>            </li>
                                <li class="">
                                    <a class="text-uppercase" href="/en/projects">en</a>            </li>
                            </ul>

                            <a class="phone d-block d-lg-none" href="tel:+380634892695">+38 (063) 489-26-95</a>

                            <div class="login-block d-none">
                                <a class="btn btn-default btn-login" id="user-signin" href="#">Вход для клиентов</a>

                            </div>
                            <ul class="list-unstyled social-icons ">
                                <li><a href=""><i class="icon-instagram"></i></a></li>
                                <li><a href=""><i class="icon-facebook"></i></a></li>
                                <li class="d-none"><a href=""><i class="icon-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
