...
Yii::import("app.phpoffice.common.src.Common.Text");
...
use AbstractElement as Element;
use Text as CommonText;
 ...
 * @since 0.11.0
 */
abstract class Word2007AbstractElement
{
    /**
     * XML writer
     *
     ...
     * @param bool $withoutP
     */
    public function __construct(Common_XMLWriter $xmlWriter, Element $element, $withoutP = false)
    {
