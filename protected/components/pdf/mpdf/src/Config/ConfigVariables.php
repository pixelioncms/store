...
use Mpdf\Ucdn;
*/
Yii::import('app.pdf.mpdf.src.Ucdn');
#Yii::import('app.pdf.mpdf.src.Language.LanguageToFont');
#Yii::import('app.pdf.mpdf.src.Language.ScriptToLanguage');
Yii::import('app.pdf.mpdf.src.Css.DefaultCss');
