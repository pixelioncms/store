...
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Part.AbstractPart");
Yii::import("app.phpoffice.phpword.src.PhpWord.Settings");
Yii::import("app.phpoffice.phpword.src.PhpWord.Style");
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Style.Table");
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Style.Paragraph");
Yii::import("app.phpoffice.phpword.src.PhpWord.Writer.Word2007.Style.Font");
use Settings as PhpWordSettings;
use Table as TableStyleWriter;
use Font as FontStyleWriter;
use Paragraph as ParagraphStyleWriter;

Yii::import("app.phpoffice.phpword.src.PhpWord.Style.Paragraph");
Yii::import("app.phpoffice.phpword.src.PhpWord.Style.Table");
Yii::import("app.phpoffice.phpword.src.PhpWord.Style.Font");

use Font as FontStyle;
use Paragraph as ParagraphStyle;
use Table as TableStyle;
