...
class FacebookOAuthService extends EOAuth2Service {
	...
	protected $scope = ''; //,user_gender,user_link,user_birthday,user_age_range
	...
	protected function fetchAttributes() {
		...
		$info = (object)$this->makeSignedRequest('https://graph.facebook.com/v3.1/me', array(
			'query' => array(
				'fields' => join(',', array(
					'id',
					'name',
        ...
        $this->attributes['photo'] = $info->picture->data->url;
