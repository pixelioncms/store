            ...
            return this.each(function () {
                ...
                if (settings.selectableRows > 0) {
                    ...
                    $(document).on('click.yiiGridView', '#' + id + ' .' + settings.tableClass + ' > tbody > tr', function (e) {
                        ...
                        isRowSelected = $row.toggleClass('active').hasClass('active');


                        $checks.prop('checkbox', isRowSelected);
                        ...
                        $('input.checker', $row).prop('checked', isRowSelected);
                    ...
                    //  $(document).on('click.yiiGridView', '#' + id + ' .checker', false);
                }
            });
        },
        /**
        ...
        update: function (options) {
            ...
            return this.each(function () {
                ...
                options = $.extend({
                    ...
                    complete: function () {
                        yiiXHR[id] = null;
                        $grid.find('.grid-loading').removeClass(settings.loadingClass);
                    },
                ...
                $grid.find('.grid-loading').addClass(settings.loadingClass);
