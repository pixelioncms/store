 ...
 */
Yii::import('app.phpword.PHPWord.Writer.Word2007.Base');
Yii::import('app.phpword.PHPWord.Shared.Shared_XMLWriter');
Yii::import('app.phpword.PHPWord.Section.Section_MemoryImage');
Yii::import('app.phpword.PHPWord.Section');
...
class Document extends Base {
		...
		if($countSections > 0) {
			foreach($_sections as $section) {
				...
				foreach($_elements as $element) {
					...
					} elseif($element instanceof Section_TextRun) {
						$this->_writeTextRun($objWriter, $element);
					} elseif($element instanceof Section_Link) {
						$this->_writeLink($objWriter, $element);
					} elseif($element instanceof Section_Title) {
						$this->_writeTitle($objWriter, $element);
					} elseif($element instanceof Section_TextBreak) {
						$this->_writeTextBreak($objWriter);
					} elseif($element instanceof Section_PageBreak) {
						$this->_writePageBreak($objWriter);
					} elseif($element instanceof Section_Table) {
						$this->_writeTable($objWriter, $element);
					} elseif($element instanceof Section_ListItem) {
						$this->_writeListItem($objWriter, $element);
					} elseif($element instanceof Section_Image ||
						$element instanceof Section_MemoryImage) {
						$this->_writeImage($objWriter, $element);
					} elseif($element instanceof Section_Object) {
	...
	private function _writeSection(Shared_XMLWriter $objWriter = null, Section $section) {
	...
	private function _writeEndSection(Shared_XMLWriter $objWriter = null, Section $section) {
	...
	private function _writePageBreak(Shared_XMLWriter $objWriter = null) {
		$objWriter->startElement('w:p');
	...
	private function _writeListItem(Shared_XMLWriter $objWriter = null, PHPWord_Section_ListItem $listItem) {
	...
	protected function _writeObject(Shared_XMLWriter $objWriter = null, PHPWord_Section_Object $object) {
	...
	private function _writeTOC(Shared_XMLWriter $objWriter = null) {
