...
Yii::import('app.pdf.mpdf.src.Mpdf');
...
class Pdf extends CApplicationComponent {
     ...
     */
    public $cssFile = 'app.pdf.assets.mpdf-bootstrap.min.css';
    ...
    public function initTempPaths() {
        if (empty($this->tempPath)) {
            $this->tempPath = Yii::getPathOfAlias('application.runtime.mpdf');
        }
    ...
    public function getApi($options = array()) {
        ...
        $this->options['format'] = (isset($options['format'])) ? $options['format'] : $this->format;
        $this->options['mode'] = (isset($options['mode'])) ? $options['mode'] : $this->mode;
        $this->options['default_font_size'] = (isset($options['default_font_size'])) ? $options['default_font_size'] : $this->defaultFontSize;
        $this->options['default_font'] = (isset($options['default_font'])) ? $options['default_font'] : $this->defaultFont;
        $this->options['margin_left'] = (isset($options['margin_left'])) ? $options['margin_left'] : $this->marginLeft;
        $this->options['margin_right'] = (isset($options['margin_right'])) ? $options['margin_right'] : $this->marginRight;
        $this->options['margin_top'] = (isset($options['margin_top'])) ? $options['margin_top'] : $this->marginTop;
        $this->options['margin_bottom'] = (isset($options['margin_bottom'])) ? $options['margin_bottom'] : $this->marginBottom;
        $this->options['margin_header'] = (isset($options['margin_header'])) ? $options['margin_header'] : $this->marginHeader;
        $this->options['margin_footer'] = (isset($options['margin_footer'])) ? $options['margin_footer'] : $this->marginFooter;
        $this->options['orientation'] = (isset($options['orientation'])) ? $options['orientation'] : $this->orientation;
