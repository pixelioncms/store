...
Yii::import('app.phpword.PHPWord.Style');
...
class Styles extends Base {
	...
	private function _writeFullTableStyle(Shared_XMLWriter $objWriter = null, PHPWord_Style_TableFull $style) {
	...
	private function _writeRowStyle(Shared_XMLWriter $objWriter = null, $type, PHPWord_Style_TableFull $style) {
		$brdSz = $style->getBorderSize();
		$brdCol = $style->getBorderColor();
		$bgColor = $style->getBgColor();
	...
	private function _writeDocDefaults(Shared_XMLWriter $objWriter = null) {
