            ...
            .each(function () {
                ...
                MultiFile.addToList = function (slave, slave_count, files) {
                    ...
                    $.each(files, function (i, file) {
                        ...
                        if (MultiFile.preview) {
                            var label = $(
                                (
                                    '<div class="MultiFile-file-col img-thumbnail1" title="' + t + '">' +
                            ...
                            var label = $(
                                (
                                    '<span class="MultiFile-label1" title="' + t + '">' +
                    ...
                    var removeClass = (MultiFile.preview) ?'btn btn-block btn-sm btn-danger': 'btn btn-sm btn-danger';
                    var
                        r = $('<div class="MultiFile-container img-thumbnail"></div>'),
                        b = $('<a class="MultiFile-remove '+removeClass+'" href="#' + MultiFile.wrapID + '">' + MultiFile.STRING.remove + '</a>')
