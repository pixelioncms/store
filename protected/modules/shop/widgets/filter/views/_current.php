    ...
    <div class="card" id="filter-current">
        ...
        <div class="card-collapse collapse" id="filter<?= md5('current-filter'); ?>">
            <div class="card-body">
                ...
                var_dump($this->getOwner()->model->getUrl());
                echo Html::link(Yii::t('ShopModule.default', 'RESET_FILTERS_BTN'), $this->getOwner()->model->getUrl(), array('class' => 'btn btn-sm btn-outline-secondary'));
                ?>
            </div>
        </div>
    </div>
